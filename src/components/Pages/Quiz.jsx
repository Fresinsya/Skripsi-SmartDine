        ...
        if (isLogin === true) {
            ...
            if (tglSelesai <= currentDate) {
                if (formLengkap === true) {
                    ...
                    alert("Data belum lengkap2 quizzzz");
                }
            } else {
                alert("Periode masih berjalan quizzzzz");
            }
        } 
        // else {
        //     console.log('riwayat eroro quizzz');
        // }
        // if (!riwayat && isLogin === true) {
        //     const dataKirim = { riwayat: riwayat, id: id, kondisi: data.data };
