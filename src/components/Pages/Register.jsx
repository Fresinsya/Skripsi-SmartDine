              ...
              {showModal && (
                <div className='absolute z-50'>
                  {showNotificationSukses && (
                    <div className="flex fixed z-50 top-5 overlay right-0 p-4 mb-4 text-sm text-white border border-green-500 rounded-full bg-green-500 dark:bg-gray-800 dark:text-white dark:border-green-500" role="alert">
